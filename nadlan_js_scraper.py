#!/usr/bin/env python3
"""
Nadlan JavaScript Bundle Scraper
...
class NadlanJSScraper:
    ...
    def analyze_js_bundle(self, js_content: str, settlement_id: str, settlement_name: str):
        ...
        if found_endpoints:
            ...
            for endpoint in set(found_endpoints)[:10]:  # Show first 10 unique
                print(f"      {endpoint}")
        ...
        if found_fetches:
            ...
            for fetch in set(found_fetches)[:10]:  # Show first 10 unique
...
def main():
    print("📜 Nadlan JavaScript Bundle Analyzer")
    print("====================================\n")
    
    scraper = NadlanJSScraper()
    
    # Test with a few settlements to analyze JavaScript
